    ...
    return (
        <div className="mt-6">
            ...
            <div className="mt-6">
                ...
                <Animate staggerChildren={0.25} className="mt-1 flex flex-wrap justify-center -ml-4">
                    {skill.tools.map((skillTool) => (
                        <AnimateChild key={skillTool.name} variants={fadeUpScale} className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 pl-4 pt-4">
