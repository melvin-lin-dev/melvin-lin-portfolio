...
export default function AboutNode({ data }: any) {
    ...
    return (
        <>
            <div className="relative p-4 bg-white border rounded-lg shadow-md w-80 text-center pointer-events-auto overflow-hidden group" onMouseEnter={handleHover} onMouseLeave={handleHover}>
                ...
                <div className="relative">
                    ...
                    <h3 className="text-lg font-bold text-gray-700 transition duration-[.4s] group-hover:text-white tracking-wider">{data.label.toUpperCase()}</h3>
